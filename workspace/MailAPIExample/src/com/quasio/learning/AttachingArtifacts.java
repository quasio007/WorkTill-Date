...
public class AttachingArtifacts {
     

public void send2() {
    final String username = "ocis007.godara@gmail.com"; //ur email
    final String password = "9024463692";
    ...
    try {
        ...
        message.setFrom(new InternetAddress("ocis007.godara@gmail.com"));//ur email
        message.setRecipients(Message.RecipientType.TO,
                InternetAddress.parse("mohit007.godara@gmail.com"));//u will send to
